...
function Lesson(props)  {
    ...
    return (
        <div
            className='max-w-screen-xl border border-8 border-b-white bg-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>

            <div className="block rounded-md shadow-sm" role="group">
                <div className=" inline-block rounded-md shadow-sm" role="group"><img
                    className="inline-block justify-center w-1/2 p-8 rounded-t-lg"
                    src="/course1.png"
                    alt="product image"/></div>
                <h1 className='mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white'>Введение</h1>
                <div
                    className="inline-block justify-center rounded-md shadow-sm w-1/2 mb-2 text-sm font-bold tracking-tight text-gray-900 dark:text-white"
                    role="group">
