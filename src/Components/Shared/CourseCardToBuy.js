...
function CourseCardToBuy(props) {
    ...
    return (
        <div
            ...
            <div className="px-5 pb-5">
                <NavLink
                    className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group"
                    aria-current="page" to={props.url ?? "/aboutcourse"}>
                ...
                <div className="flex items-center justify-between">
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">{props.price ?? "$599"}</div>
                    <NavLink aria-current="page" to={props.url ?? "/aboutcourse"}
                       className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        {props.buttontitle ?? "Подробнее"}
                    </NavLink>
                </div>
            </div>
        </div>
...
export default CourseCardToBuy;