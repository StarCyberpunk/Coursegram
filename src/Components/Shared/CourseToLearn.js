...
import ButtonOfTopic from "./SingleComponents/ButtonOfTopic";
import {NavLink} from "react-router-dom";

function CourseToLearn(props) {
    ...
    return (
        <div
            ...
            <NavLink
                ...
                aria-current="page" to={props.url ?? "/aboutcourse"}><img className=" p-8 rounded-t-lg"
                                                                          src={props.img ?? "/course1.png"}
            ...
            <ul className="my-4 space-y-3 min-w-96 m-12">
                <li>
                    <ButtonOfTopic href="topic"/>
                </li>
                <li>
                    <ButtonOfTopic href="topic"/>
                </li>
